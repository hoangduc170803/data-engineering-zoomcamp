...
PARQUET_FILE = 'output_green_taxi_{{ execution_date.strftime("%Y-%m") }}.parquet'
...
def download_green_taxi_data(url, parquet_file):
    """
...
upload_data_to_gcs = PythonOperator(
    ...
    op_kwargs={
        ...
        'local_file': f"{PATH_TO_LOCAL_HOME}/output_green_taxi_{{{{ execution_date.strftime('%Y-%m') }}}}.parquet",
